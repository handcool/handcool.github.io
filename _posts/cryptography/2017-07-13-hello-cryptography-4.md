...
（关于随机化算法和确定化算法的解释请见[你好，密码学(2)：离散概率（速成课）](http://p5shyx2m0.bkt.clouddn.com/hello-cryptography-2.png)）
...
（上述表达式中的$\oplus$表示异或运算，关于异或运算的详细解释请见[你好，密码学(3)：离散概率（速成课）（续）](http://sun.ffyu.top/2017/04/20/hello-cryptography-3/)）
...
![Claude-Elwood-Shannon](http://p5shyx2m0.bkt.clouddn.com/Claude-Elwood-Shannon.jpg)
